...
export default async function Home() {
  ...
  return (
    <main className="min-h-dvh overflow-hidden bg-canvas">
      ...
      <footer className="mx-auto max-w-[1500px] px-5 py-10 lg:px-10"><div className="flex flex-col gap-5 border-b border-white/10 pb-8 sm:flex-row sm:items-center sm:justify-between"><RunnerLogo /><p className="text-xs font-black uppercase tracking-[.2em] text-text-subtle">WE RUN SPORTS AND ANALYTICS.</p></div><div className="pt-7"><ResponsibleGamblingNotice /><p className="mt-4 text-[10px] text-text-subtle">© 2026 Runner Sports &amp; Analytics LLC · Research and analytics only · Not a sportsbook</p></div></footer>
    </main>
  );
}
