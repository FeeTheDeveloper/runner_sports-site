    ...
    <main className="hero-stadium min-h-dvh px-5 py-8">
      ...
      <div className="mx-auto grid min-h-[calc(100dvh-100px)] max-w-6xl items-center gap-12 py-12 lg:grid-cols-2">
        <section>
          ...
          <p className="mt-6 max-w-lg text-base leading-7 text-text-muted">One identity across picks, saved research, alerts, model access and billing. We run sports &amp; analytics.</p>
        </section>
